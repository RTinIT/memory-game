...
function reset() {
  changedCard = closePlayingField = false;
  first = second = null;
}

function showSteps() {
  step += 1;
  stepsBlock.innerHTML = `Steps = ${step}`;
}
...
function getScoreList() {
  ...
  scoreList.forEach(
    (elem) =>
      (sl.innerHTML += `<li>${elem.name}..............................${elem.steps}</li><br>`)
  );
}
